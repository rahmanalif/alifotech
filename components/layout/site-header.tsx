...
const navItems = [
  ...
  { label: "Services", href: "#services", hasIndicator: true },
        ...
        <nav className="hidden items-center gap-2 lg:flex">
          {navItems.map((item) => (
            <Link
              ...
              href={item.href}
              className={cn(
                "inline-flex items-center gap-1 rounded-full px-4 py-2 text-sm font-semibold text-foreground/80 transition-colors",
